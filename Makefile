...
upload-statics:
	...
	cf worker write-kv --organization-id $(ORGID) --namespace-id $(NAMESPACEID) --key static/fixing-capital-one.md --value @static/fixing-capital-one.md
	...
	cf worker write-kv --organization-id $(ORGID) --namespace-id $(NAMESPACEID) --key static/cloud-duct-tape.md --value @static/cloud-duct-tape.md
